...
type ThreadInfo struct {
	...
	LastReplyer          *User                        `protobuf:"bytes,19,opt,name=last_replyer,json=lastReplyer,proto3" json:"last_replyer,omitempty"`
...
func (x *ThreadInfo) GetLastReplyer() *User {
	if x != nil {
		return x.LastReplyer
	}
	return nil
}
...
const file_ThreadInfo_proto_rawDesc = "" +
	...
	"User.proto\x1a\vVoice.proto\x1a\x0ePollInfo.proto\x1a\x0fVideoInfo.proto\x1a\x0fPbContent.proto\x1a\vAgree.proto\x1a\vMedia.proto\"\xd4\n" +
	"\n" +
	"\n" +
	"ThreadInfo\x12\x0e\n" +
	...
	"\flast_replyer\x18\x13 \x01(\v2\x05.UserR\vlastReplyer\x12%\n" +
	"\n" +
	...
	"\vis_frs_mask\x18\xc6\x01 \x01(\x05R\tisFrsMask\x1a\xb2\x02\n" +
	...
	"\x03pid\x18\x19 \x01(\x03R\x03pidb\x06proto3"
...
var file_ThreadInfo_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_ThreadInfo_proto_goTypes = []any{
	...
	(*User)(nil),                        // 2: User
	(*Voice)(nil),                       // 3: Voice
	(*PollInfo)(nil),                    // 4: PollInfo
	(*VideoInfo)(nil),                   // 5: VideoInfo
	(*Agree)(nil),                       // 6: Agree
	(*PbContent)(nil),                   // 7: PbContent
	(*Media)(nil),                       // 8: Media
}
var file_ThreadInfo_proto_depIdxs = []int32{
	2,  // 0: ThreadInfo.author:type_name -> User
	2,  // 1: ThreadInfo.last_replyer:type_name -> User
	3,  // 2: ThreadInfo.voice_info:type_name -> Voice
	4,  // 3: ThreadInfo.poll_info:type_name -> PollInfo
	5,  // 4: ThreadInfo.video_info:type_name -> VideoInfo
	6,  // 5: ThreadInfo.agree:type_name -> Agree
	1,  // 6: ThreadInfo.origin_thread_info:type_name -> ThreadInfo.OriginThreadInfo
	7,  // 7: ThreadInfo.first_post_content:type_name -> PbContent
	8,  // 8: ThreadInfo.OriginThreadInfo.media:type_name -> Media
	3,  // 9: ThreadInfo.OriginThreadInfo.voice_info:type_name -> Voice
	5,  // 10: ThreadInfo.OriginThreadInfo.video_info:type_name -> VideoInfo
	7,  // 11: ThreadInfo.OriginThreadInfo.content:type_name -> PbContent
	4,  // 12: ThreadInfo.OriginThreadInfo.poll_info:type_name -> PollInfo
