...
type Voice struct {
	...
	DuringTime    int32                  `protobuf:"varint,2,opt,name=during_time,json=duringTime,proto3" json:"during_time,omitempty"`
	VoiceMd5      string                 `protobuf:"bytes,3,opt,name=voice_md5,json=voiceMd5,proto3" json:"voice_md5,omitempty"`
...
func (x *Voice) GetDuringTime() int32 {
	if x != nil {
		return x.DuringTime
	}
	return 0
...
func (x *Voice) GetVoiceMd5() string {
	if x != nil {
		return x.VoiceMd5
	}
	return ""
...
const file_Voice_proto_rawDesc = "" +
	...
	"\vVoice.proto\"E\n" +
	"\x05Voice\x12\x1f\n" +
	"\vduring_time\x18\x02 \x01(\x05R\n" +
	"duringTime\x12\x1b\n" +
	"\tvoice_md5\x18\x03 \x01(\tR\bvoiceMd5b\x06proto3"
...
var file_Voice_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
