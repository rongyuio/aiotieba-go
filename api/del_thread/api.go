// Package delthread implements the del_thread API of aiotieba.
//
// It mirrors the Python package aiotieba.api.del_thread.
package delthread
...
//
// isHide hides the thread from the forum listing instead of removing it.
