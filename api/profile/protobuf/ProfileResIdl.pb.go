...
func (x *ProfileResIdl) GetError() *protobuf.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type ProfileResIdl_DataRes struct {
	...
	PostList      []*protobuf.PostInfoList             `protobuf:"bytes,4,rep,name=post_list,json=postList,proto3" json:"post_list,omitempty"`
...
func (x *ProfileResIdl_DataRes) GetUser() *protobuf.User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *ProfileResIdl_DataRes) GetPostList() []*protobuf.PostInfoList {
	if x != nil {
		return x.PostList
	}
	return nil
...
const file_ProfileResIdl_proto_rawDesc = "" +
	...
	"daysTofree\x1a7\n" +
	"\rUserAgreeInfo\x12&\n" +
	"\x0ftotal_agree_num\x18\x01 \x01(\x03R\rtotalAgreeNumb\x06proto3"
...
var file_ProfileResIdl_proto_goTypes = []any{
	...
	(*protobuf.Error)(nil),                      // 4: Error
	(*protobuf.User)(nil),                       // 5: User
	(*protobuf.PostInfoList)(nil),               // 6: PostInfoList
}
