...
type ProfileReqIdl_DataReq struct {
	...
	Common            *protobuf.CommonReq    `protobuf:"bytes,9,opt,name=common,proto3" json:"common,omitempty"`
...
func (x *ProfileReqIdl_DataReq) GetCommon() *protobuf.CommonReq {
	if x != nil {
		return x.Common
	}
	return nil
...
const file_ProfileReqIdl_proto_rawDesc = "" +
	...
	"\x13friend_uid_portrait\x18\x10 \x01(\tR\x11friendUidPortraitb\x06proto3"
