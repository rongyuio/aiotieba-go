// Package followuser implements the follow_user API of aiotieba.
//
// It mirrors the Python package aiotieba.api.follow_user.
package followuser
...
func RequestURL() *url.URL {
	return &url.URL{Scheme: "https", Host: consts.AppBaseHost, Path: "/c/c/user/follow"}
}
