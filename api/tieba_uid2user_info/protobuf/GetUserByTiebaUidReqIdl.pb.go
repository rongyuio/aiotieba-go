...
type GetUserByTiebaUidReqIdl_DataReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Common        *protobuf.CommonReq    `protobuf:"bytes,1,opt,name=common,proto3" json:"common,omitempty"`
...
func (x *GetUserByTiebaUidReqIdl_DataReq) GetCommon() *protobuf.CommonReq {
	if x != nil {
		return x.Common
	}
	return nil
...
const file_GetUserByTiebaUidReqIdl_proto_rawDesc = "" +
	...
	"\ttieba_uid\x18\x02 \x01(\tR\btiebaUidb\x06proto3"
