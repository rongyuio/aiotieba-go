...
func (x *UserMuteQueryResIdl) GetError() *protobuf.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type UserMuteQueryResIdl_DataRes struct {
	...
	Page          *protobuf.Page                          `protobuf:"bytes,2,opt,name=page,proto3" json:"page,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserMuteQueryResIdl_DataRes) GetPage() *protobuf.Page {
	if x != nil {
		return x.Page
	}
	return nil
...
const file_UserMuteQueryResIdl_proto_rawDesc = "" +
	...
	"\tname_show\x18\x05 \x01(\tR\bnameShowb\x06proto3"
