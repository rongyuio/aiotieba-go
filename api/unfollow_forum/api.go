// Package unfollowforum implements the unfollow_forum API of aiotieba.
//
// It mirrors the Python package aiotieba.api.unfollow_forum.
package unfollowforum
...
func RequestURL() *url.URL {
	return &url.URL{Scheme: "https", Host: consts.AppBaseHost, Path: "/c/c/forum/unfavolike"}
}
